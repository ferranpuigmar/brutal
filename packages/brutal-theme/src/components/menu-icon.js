...
export const BrutalLogo = ({ size, color, ...props }) => {
  return (
    <svg
      height={size}
      width={size}
    ...
    >
      <title>Close Menu</title>
      <g fill="currentColor">
        <path d="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.gastronomiabrutal.com%2F&psig=AOvVaw3VSuFUKkNKGwfdmt8nj535&ust=1627072553264000&source=images&cd=vfe&ved=0CAsQjRxqFwoTCPjXquLD9_ECFQAAAAAdAAAAABAO" />
      </g>
    </svg>
  );
};